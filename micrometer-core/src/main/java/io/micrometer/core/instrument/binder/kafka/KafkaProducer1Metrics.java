...
@NonNullApi
@NonNullFields
public final class KafkaProducer1Metrics extends Kafka1Metrics {
    public KafkaProducer1Metrics(Producer<?, ?> kafkaProducer) {
        super(kafkaProducer::metrics);
    }

    public KafkaProducer1Metrics(Producer<?, ?> kafkaProducer, Iterable<Tag> tags) {
