...
@NonNullApi
@NonNullFields
public final class KafkaStreams1Metrics extends Kafka1Metrics {

    public KafkaStreams1Metrics(KafkaStreams kafkaStreams) {
        super(kafkaStreams::metrics);
    }

    public KafkaStreams1Metrics(KafkaStreams kafkaStreams, Iterable<Tag> tags) {
